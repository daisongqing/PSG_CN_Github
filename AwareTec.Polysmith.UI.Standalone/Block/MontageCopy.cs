...
{
    public partial class MontageCopy : SkinForm
    {
        ...
        public string m_strResetAlert = Program.Language == "EN" ? "Do you need to restore to the initial settings？" : "是否需要恢复到初始设置?";
        public string m_strSaveAlert = Program.Language == "EN" ? "Do you want to save the current configuration plan？" : "是否需要保存当前配置方案?";
