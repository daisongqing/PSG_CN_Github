...
{
    public partial class MarkerEdit : SkinForm
    {
        public MarkerEdit()
        {
            InitializeComponent();
        ...
        private void MarkerEdit_Load(object sender, EventArgs e)
        {
            ...
            if (CurrentMarker != null)
            {
                ...
                colorPickerControl1.Color = CurrentMarker.BackColor;
        ...
        private void SaveButton_Click(object sender, EventArgs e)
        {
            if (SaveMarkerEventHandle != null)
            {
                ...
                CurrentMarker.BackColor = colorPickerControl1.Color;
                ...
                DataModel.LogInstance.Default.AddLog(string.Format("用户点击 事件编辑-提交按钮 编辑的事件名称为 {0}，分类为 {1}，最小时域为 {2}",CurrentMarker.Name, RbAreaLabel.Checked?"区域标签":"点位标签", TbMinTime.Text.Trim()), pSystem.LogManagement.LogLevel.INFO);
        ...
        private void RbPointLabel_CheckedChanged(object sender, EventArgs e)
        {
            if (RbPointLabel.Checked)
            {
                ...
                colorPickerControl1.Location = new Point(colorPickerControl1.Location.X, pianyi - 5);
                m_noHot = true;
                TbHotKey.Text = "无";
            }
            else
            {
                ...
                colorPickerControl1.Location = new Point(colorPickerControl1.Location.X, label2.Location.Y + 90);
                m_noHot = false;
                TbHotKey.Text = "";
            }
        }
