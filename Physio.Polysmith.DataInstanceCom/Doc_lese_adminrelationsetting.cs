...
namespace Physio.Polysmith.DataInstanceCom
{
    ...
    /// 与账户配套的系统参数配置表
    /// </summary>
    public class Doc_lese_adminrelationsetting : ITable
    {
        #region 私有成员
        private int m_ID = 0;
        ...
        {
            return ("lese_adminrelationsetting");
        }
        ...
        {
            return (new Doc_lese_adminrelationsetting());
        }
        #endregion
        ...
        /// Edf的上传路径
        /// </summary>
        public string LoadUpEdfPath { set; get; }
        /// <summary>
        /// 最终确定的edf路径
        /// </summary>
        public string LastEdfPath { set; get; }
    }
}
