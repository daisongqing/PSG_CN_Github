...
namespace AwareTec.Polysmith.Vedio
{
    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        public const int NET_DVR_SET_TIMECORRECT = 432;///设置DVR时间(针对网络摄像头)
        ...
        **********************************************************/
        ...
        /// <returns></returns>
        [DllImport("pvedio\\HCNetSDK.dll")]
        public static extern bool NET_DVR_SetSDKLocalCfg(NET_SDK_LOCAL_CFG_TYPE enumType, ref NET_DVR_LOCAL_GENERAL_CFG Info);

        [DllImport("pvedio\\HCNetSDK.dll")]
        public static extern bool NET_DVR_GetSDKLocalCfg(NET_SDK_LOCAL_CFG_TYPE enumType, ref NET_DVR_LOCAL_GENERAL_CFG Info);
        /*********************************************************
        Function:	REALDATACALLBACK
        Desc:		(回调函数)
        Input:	
        ...
        **********************************************************/
        ...
        [DllImport("pvedio\\GetStream.dll")]
        ...
        //模块初始化
        [DllImport("pvedio\\PdCssVodClient.dll")]
        ...
        ******************************************************************************/
        ...
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_InputData(int nPort, byte[] pBuf, int nSize);
        ...
        public delegate void FileRefDoneCB(uint nPort, uint nUser);
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_SetFileRefCallBack(int nPort, FileRefDoneCB pFileRefDone, uint nUser);

        public delegate void FileEndCallback(int nPort, IntPtr pUser);
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_SetFileEndCallback(int nPort, FileEndCallback fFileEndCBFun, IntPtr pUser);
        
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_OpenFile(int nport, string strFilePath);

        public delegate void DisplayCBFun(int nPort, byte[] pBuf, int nSize, int nWidth, int nHeight, int nStamp, int nType, int nReceved);
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_SetDisplayCallBack(int nPort, DisplayCBFun fDisplayCBFun);

        public delegate void DecCBFunDelegate(int nPort,IntPtr pBuf,int nSize,ref FRAME_INFO pFrameInfo,int nReserved1,int nReserved2);
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_SetDecCallBack(int nPort, DecCBFunDelegate fDecCBFun);

        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_SetDecCallBackExMend(int nPort, DecCBFunDelegate fDecCBFun,byte[] pDest, int nDestSize, int nUser);
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_SetDisplayBuf(int nPort, uint nBufPoolSize);
        /// <summary>
        /// 获取最后一帧的时间，用于文件拼接（现在已经被暂停功能）
        /// </summary>
        /// <param name="nPort"></param>
        ...
        /// <returns></returns>
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_SetDisplayRegion(int nPort, uint nRegionNum,ref Rectangle pSrcRect, IntPtr hDestWnd, bool bEnable);
       ...
       [DllImport("pvedio\\PlayCtrl.dll")]
        ...
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_SetCurrentFrameNum(int nport, uint frameno);
        [DllImport("pvedio\\PlayCtrl.dll")]
        ...
        /// 帧序号
        /// </summary>
        public static readonly uint BY_FRAMENUM = 1;
        /// <summary>
        /// 时间
        /// </summary>
        public static readonly uint BY_FRAMETIME = 2;
        [DllImport("pvedio\\PlayCtrl.dll")]
        ...
        /// <returns></returns>
        [DllImport("pvedio\\PlayCtrl.dll")]
        public static extern bool PlayM4_Pause(int nPort, int nPause);
        ...
        [DllImport("pvedio\\RecordDLL.dll")]
        ...
        [DllImportAttribute("pvedio\\HCNetSDK.dll")]
