...
namespace pSystem.UI.Register
{
    ...
    {
        /// <summary>
        /// MD5 加密静态方法 [.NET类库中自带的算法 MD5是个不可逆的算法 没有解密的算法
        /// </summary>
        ...
        public static string AESEncrypt(string EncryptString, string EncryptKey)
        {
            ...
            // byte[] m_btIV = Convert.FromBase64String("Rkb4jvUy/ye7Cd7k89KKgQ==");//"Rkb4jvUy/ye7Cd7k89QQgQ=="
            ...
            try
            {
                ...
                MemoryStream m_stream = new MemoryStream();
                ICryptoTransform ic = m_AESProvider.CreateEncryptor(Encoding.Default.GetBytes(EncryptKey), m_btIV);
