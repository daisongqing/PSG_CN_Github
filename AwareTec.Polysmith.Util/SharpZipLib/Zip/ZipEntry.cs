...
// HISTORY 22-12-2009 DavidPierson Added AES support 02-02-2010 DavidPierson Changed NTFS Extra Data
// min length to 4
...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    /// <summary>
    /// This class represents an entry in a zip archive. This can be a file or a directory ZipFile
    /// and ZipInputStream will give you instances of this class as information about the members in
    /// an archive. ZipOutputStream uses an instance of this class when creating an entry in a Zip
    /// file. <br/><br/> Author of the original java version : Jochen Hoenicke
    /// </summary>
    public class ZipEntry : ICloneable
    {
        ...
        /// </summary>
        /// <param name="name">
        /// The name for this entry. Can include directory components. The convention for names is
        /// 'unix' style paths with relative names only. There are with no device names and path
        ...
        /// This is not enforced see <see cref="CleanName(string)"> CleanName </see> on how to ensure
        ...
        /// </exception>
        /// <remarks>
        /// This constructor is used by the ZipFile class when reading from the central header It is
        /// not generally useful, use the constructor specifying the name only.
        /// </remarks>
        ...
        /// interpretation of <see cref="Flags"> flags </see>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Get / set a flag indicating wether entry name and comment text are encoded in <a
        /// href="http://www.unicode.org"> unicode UTF8 </a>.
        /// </summary>
        /// <remarks>
        /// This is an assistant that interprets the <see cref="Flags"> flags </see> property.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// General purpose bit flag <br/><br/> Bit 0: If set, indicates the file is encrypted <br/>
        /// Bit 1-2 Only used for compression type 6 Imploding, and 8, 9 deflating <br/>
        /// Imploding: <br/> Bit 1 if set indicates an 8K sliding dictionary was used. If clear a 4k
        /// dictionary was used <br/> Bit 2 if set indicates 3 Shannon-Fanno trees were used to
        /// encode the sliding dictionary, 2 otherwise <br/><br/>
        /// Deflating: <br/> Bit 2 Bit 1 <br/> 0 0 Normal compression was used <br/> 0 1 Maximum
        /// compression was used <br/> 1 0 Fast compression was used <br/> 1 1 Super fast compression
        /// was used <br/><br/> Bit 3: If set, the fields crc-32, compressed size and uncompressed
        /// size are were not able to be written during zip file creation The correct values are held
        /// in a data descriptor immediately following the compressed data. <br/> Bit 4: Reserved for
        /// use by PKZIP for enhanced deflating <br/> Bit 5: If set indicates the file contains
        /// compressed patch data <br/> Bit 6: If set indicates strong encryption was used. <br/> Bit
        /// 7-10: Unused or reserved <br/> Bit 11: If set the name and comments for this entry are in
        /// <a href="http://www.unicode.org"> unicode </a>. <br/> Bit 12-15: Unused or reserved <br/>
        /// </remarks>
        ...
        /// <summary>
        /// Get/Set external file attributes as an integer. The values of this are operating system
        /// dependant see <see cref="HostSystem"> HostSystem </see> for details
        /// </summary>
        ...
        /// <summary>
        /// Get the version made by for this entry or zero if unknown. The value / 10 indicates the
        /// major version number, and the value mod 10 is the minor version number
        /// </summary>
        ...
        /// <summary>
        /// Test the external attributes for this <see cref="ZipEntry"/> to see if the external
        /// attributes are Dos based (including WINNT and variants) and match the values
        /// </summary>
        /// <param name="attributes"> The attributes to test. </param>
        /// <returns>
        /// Returns true if the external attributes are known to be DOS/Windows based and have the
        /// same attributes set as the value passed.
        /// </returns>
        ...
        /// <summary>
        /// Gets the compatability information for the <see cref="ExternalFileAttributes"> external
        /// file attribute </see> If the external file attributes are compatible with MS-DOS and can
        /// be read by PKZIP for DOS version 2.04g then this value will be zero. Otherwise the value
        /// will be non-zero and identify the host system on which the attributes are compatible.
        /// </summary>
        /// <remarks>
        /// The values for this as defined in the Zip File format and by others are shown below. The
        /// values are somewhat misleading in some cases as they are not all used as shown. You
        /// should consult the relevant documentation to obtain up to date and correct information.
        /// The modified appnote by the infozip group is particularly helpful as it documents a lot
        /// of peculiarities. The document is however a little dated.
        /// <list type="table">
        ...
        /// </summary>
        /// <remarks>
        /// Minimum features are defined as: <br/> 1.0 - Default value <br/> 1.1 - File is a volume
        /// label <br/> 2.0 - File is a folder/directory <br/> 2.0 - File is compressed using Deflate
        /// compression <br/> 2.0 - File is encrypted using traditional encryption <br/> 2.1 - File
        /// is compressed using Deflate64 <br/> 2.5 - File is compressed using PKWARE DCL Implode
        /// <br/> 2.7 - File is a patch data set <br/> 4.5 - File uses Zip64 format extensions <br/>
        /// 4.6 - File is compressed using BZIP2 compression <br/> 5.0 - File is encrypted using DES
        /// <br/> 5.0 - File is encrypted using 3DES <br/> 5.0 - File is encrypted using original RC2
        /// encryption <br/> 5.0 - File is encrypted using RC4 encryption <br/> 5.1 - File is
        /// encrypted using AES encryption <br/> 5.1 - File is encrypted using corrected RC2
        /// encryption <br/> 5.1 - File is encrypted using corrected RC2-64 encryption <br/> 6.1 -
        /// File is encrypted using non-OAEP key wrapping <br/> 6.2 - Central directory encryption
        /// (not confirmed yet) <br/> 6.3 - File is compressed using LZMA <br/> 6.3 - File is
        /// compressed using PPMD+ <br/> 6.3 - File is encrypted using Blowfish <br/> 6.3 - File is
        /// encrypted using Twofish <br/>
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// This is based on the <see cref="Version"> </see> and wether the <see
        /// cref="IsCompressionMethodSupported()"> compression method </see> is supported.
        /// </remarks>
        ...
        /// </summary>
        /// <returns>
        /// A <see cref="bool"/> value of true if Zip64 extensions have been forced on; false if not.
        /// </returns>
        ...
        /// </summary>
        /// <value>
        /// A <see cref="bool"/> value of true if a local header requires Zip64 extensions; false if not.
        /// </value>
        ...
        /// <remarks>
        /// Setting the size before adding an entry to an archive can help avoid compatability
        /// problems with some archivers which dont understand Zip64 extensions.
        /// </remarks>
        public long Size
        {
            get
        ...
        /// <summary>
        /// Gets the compression method for outputting to the local or central header. Returns same
        /// value as CompressionMethod except when AES encrypting, which places 99 in the method and
        /// places the real method in the extra data.
        /// </summary>
        ...
        /// <summary>
        /// For AES encrypted files returns or sets the number of bits of encryption (128, 192 or
        /// 256). When setting, only 0 (off), 128 or 256 is supported.
        /// </summary>
        ...
        /// <summary>
        /// AES Encryption strength for storage in extra data in entry header. 1 is 128 bit, 2 is 192
        /// bit, 3 is 256 bit.
        /// </summary>
        ...
        internal int AESOverheadSize
        {
            get
            {
                // File format: Bytes Content Variable Salt value 2 Password verification value
                // Variable Encrypted file data 10 Authentication code
        ...
        /// True if the extra data fields should be handled for a local header, rather than for a
        /// central header.
        /// </param>
        internal void ProcessExtraData(bool localHeader)
        {
            ...
            {
                // Version required to extract is ignored here as some archivers dont set it
                // correctly in theory it should be version 45 or higher
            ...
            else if (extraData.Find(0x5455))
            {
                ...
                // Can include other times but these are ignored. Length of data should actually be 1
                // + 4 * no of bits in flags.
        ...
        public string Comment
        {
            ...
            set
            {
                // This test is strictly incorrect as the length is in characters while the storage
                // limit is in bytes. While the test is partially correct in that a comment of this
                // length or greater is definitely invalid, shorter comments may also have an invalid
                // length where there are multi-byte characters The full test is not possible here
                // however as the code page to apply conversions with isnt available.
        ...
        /// </summary>
        /// <remarks>
        /// A directory is determined by an entry name with a trailing slash '/'. The external file
        /// attributes can also indicate an entry is for a directory. Currently only dos/windows
        /// attributes are tested in this manner. The trailing slash convention should always be followed.
        /// </remarks>
        ...
        /// <summary>
        /// Cleans a name making it conform to Zip file conventions. Devices names ('c:\') and UNC
        /// share names ('\\server\share') are removed and forward slashes ('\') are converted to
        /// back slashes ('/'). Names are made relative by trimming leading slashes which is
        /// compatible with the ZIP naming convention.
        /// </summary>
