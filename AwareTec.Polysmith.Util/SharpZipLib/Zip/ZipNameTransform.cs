...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    /// </summary>
    /// <remarks>
    /// The use of absolute names is supported although its use is not valid according to Zip naming
    /// conventions, and should not be used if maximum compatability is desired.
    /// </remarks>
    public class ZipNameTransform : INameTransform
    {
        ...
        /// </summary>
        /// <remarks> The prefix is trimmed before any conversion from a windows path is done. </remarks>
        ...
        /// <remarks>
        /// Zip path names are actually in Unix format, and should only contain relative paths. This
        /// means that any path stored should not contain a drive or device letter, or a leading
        /// slash. All slashes should forward slashes '/'. An empty name is valid for a file where
        /// the input comes from standard input. A null name is not considered valid.
        /// </remarks>
        ...
        /// <returns> Returns true if the name is a valid zip name; false otherwise. </returns>
        /// <remarks>
        /// Zip path names are actually in unix format, and should only contain relative paths if a
        /// path is present. This means that the path stored should not contain a drive or device
        /// letter, or a leading slash. All slashes should forward slashes '/'. An empty name is
        /// valid where the input comes from standard input. A null name is not considered valid.
        /// </remarks>
