...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipEntryFactory : IEntryFactory
    {
        ...
        public enum TimeSetting
        {
            ...
            /// </summary>
            /// <remarks>
            /// The actual <see cref="DateTime"/> value used can be specified via the <see
            /// cref="ZipEntryFactory(DateTime)"/> constructor or using the <see
            /// cref="ZipEntryFactory(TimeSetting)"/> with the setting set to <see
            /// cref="TimeSetting.Fixed"/> which will use the <see cref="DateTime"/> when this class
            /// was constructed. The <see cref="FixedDateTime"/> property can also be used to set
            /// this value.
            /// </remarks>
            Fixed,
        }
        ...
        /// The <see cref="TimeSetting"> time setting </see> to use when creating <see
        /// cref="ZipEntry"> Zip entries </see>.
        /// </param>
        ...
        /// <summary>
        /// Get / set the <see cref="INameTransform"/> to be used when creating new <see
        /// cref="ZipEntry"/> values.
        /// </summary>
        /// <remarks>
        /// Setting this property to null will cause a default <see cref="ZipNameTransform"> name
        /// transform </see> to be used.
        /// </remarks>
