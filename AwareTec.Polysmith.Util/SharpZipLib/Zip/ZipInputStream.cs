...
// HISTORY 2010-05-25 Z-1663 Fixed exception when testing local header compressed size of -1
...
{
    /// <summary>
    /// This is an InflaterInputStream that reads the files baseInputStream an zip archive one after
    /// another. It has a special method to get the zip entry of the next file. The zip entry
    /// contains information about the file name size, compressed size, Crc, etc. It includes support
    /// for Stored and Deflated entries. <br/><br/> Author of the original java version : Jochen Hoenicke
    /// </summary>
    /// <example>
    ...
    public class ZipInputStream : InflaterInputStream
    {
        ...
        /// </summary>
        /// <value>
        /// A password for all encrypted <see cref="ZipEntry"> entries </see> in this <see cref="ZipInputStream"/>
        /// </value>
        ...
        /// </summary>
        /// <remarks>
        /// The entry can only be decompressed if the library supports the zip features required to
        /// extract it. See the <see cref="ZipEntry.Version"> ZipEntry Version </see> property for
        /// more details.
        /// </remarks>
        ...
        /// Password is not set, password is invalid, compression method is invalid, version required
        /// to extract is not supported
        /// </exception>
        public ZipEntry GetNextEntry()
        {
            ...
            // -jr- 07-Dec-2003 Ignore spanning temporary signatures if found Spanning signature is
            // same as descriptor signature and is untested as yet.
            ...
            {
                // This allows for GNU, WinZip and possibly other archives, the PKZIP spec says these
                // values are zero under these circumstances.
                if (crc2 != 0)
                {
                    entry.Crc = crc2 & 0xFFFFFFFFL;
                }
            ...
            // If local header requires Zip64 is true then the extended header should contain both values.
        ...
        /// <exception cref="ZipException"> The Zip stream ends early </exception>
        ...
        /// <summary>
        /// Perform the initial read on an entry which may include reading encryption headers and
        ...
        /// </summary>
        /// <returns>
        /// The number of bytes read (this may be less than the length requested, even before the end
        /// of stream), or 0 on end of stream.
        /// </returns>
        /// <exception name="IOException"> An i/o error occured. </exception>
        /// <exception cref="ZipException"> The deflated stream is corrupted. </exception>
