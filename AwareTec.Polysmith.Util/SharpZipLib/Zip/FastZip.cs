...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class FastZipEvents
    {
        ...
        /// </param>
        /// <returns>
        /// A <see cref="bool"/> of true if the operation should continue; false otherwise.
        /// </returns>
    ...
    public class FastZip
    {
        ...
        /// </summary>
        /// <param name="events">
        /// The <see cref="FastZipEvents"> events </see> to use during operations.
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// The default value is dynamic which is not backwards compatible with old programs and can
        /// cause problems with XP's built in compression which cant read Zip64 archives. However it
        /// does avoid the situation were a large file is added and cannot be completed correctly.
        /// NOTE: Setting the size for entries before they are added is the best solution! By default
        /// the EntryFactory used by FastZip will set fhe file size.
        /// </remarks>
        ...
        /// <summary>
        /// Get/set a value indicating wether file dates and times should be restored when extracting
        ...
        /// The <see cref="PathFilter"> file filter </see> to apply.
        /// </param>
        /// <param name="directoryFilter">
        /// The <see cref="PathFilter"> directory filter </see> to apply.
        /// </param>
        ...
        /// The style of <see cref="Overwrite"> overwriting </see> to apply.
        /// </param>
        ...
        private void ProcessFile(object sender, ScanEventArgs e)
        {
            ...
            if (e.ContinueRunning)
            {
                try
                {
                    ...
                    // file will not be changed by subsequent openers, but precludes opening in some
                    // cases were it could succeed.
