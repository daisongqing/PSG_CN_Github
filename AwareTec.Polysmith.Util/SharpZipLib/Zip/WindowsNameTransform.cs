    ...
    public class WindowsNameTransform : INameTransform
    {
        ...
        public string TransformFile(string name)
        {
            if (name != null)
            {
                ...
                // This may exceed windows length restrictions. Combine will throw a
                // PathTooLongException in that case.
        ...
        /// <remarks>
        /// The filename isnt a true windows path in some fundamental ways like no absolute paths, no
        /// rooted paths etc.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// This may not valid for all windows systems - CE?, etc but I cant find the equivalent in
        /// the CLR.
        /// </remarks>
