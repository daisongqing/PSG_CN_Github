...
// HISTORY 22-12-2009 DavidPierson Added AES support
...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public enum UseZip64
    {
        ...
        /// </summary>
        /// <remarks>
        /// An entry can have this overridden if required <see cref="ZipEntry.ForceZip64"> </see>
        /// </remarks>
        Off,
    ...
    public enum GeneralBitFlags : int
    {
        ...
        /// <summary>
        /// Bits 1 and 2 - Two bits defining the compression method (only for Method 6 Imploding and
        /// 8,9 Deflating)
        /// </summary>
        Method = 0x0006,
        ...
        /// <summary>
        /// Bit 5 if set indicates the file contains Pkzip compressed patched data. Requires version
        /// 2.7 or greater.
        /// </summary>
        Patched = 0x0020,
        ...
        /// <summary>
        /// Bit 11 if set indicates the filename and comment fields for this file must be encoded
        /// using UTF-8.
        /// </summary>
        UnicodeText = 0x0800,
        ...
        /// <summary>
        /// Bit 13 if set indicates that values in the local header are masked to hide their actual
        /// values, and the central directory is encrypted.
        /// </summary>
    ...
    public sealed class ZipConstants
    {
        ...
        /// </summary>
        /// <remarks>
        /// This is also the Zip version for the library when comparing against the version required
        /// to extract for an entry. See <see cref="ZipEntry.CanDecompress"/>.
        /// </remarks>
        ...
        /// <remarks>
        /// This is also the Zip version for the library when comparing against the version required
        /// to extract for an entry. See <see cref="ZipInputStream.CanDecompressEntry">
        ...
        /// </summary>
        /// <remarks>
        /// This is only used where the length, Crc, or compressed size isnt known when the entry is
        /// created and the output stream doesnt support seeking. The local entry cannot be 'patched'
        /// with the correct values in this case so the values are recorded after the data prefixed
        /// by this header, as well as in the central directory.
        /// </remarks>
...
#if NETCF_1_0 || NETCF_2_0
		// This isnt so great but is better than nothing. Trying to work out an appropriate OEM code
		// page would be good. 850 is a good default for english speakers particularly in Europe.
        ...
        /// Dont use unicode encodings if you want to be Zip compatible! Using the default code page
        /// isnt the full solution neccessarily there are many variable factors, codepage 850 is
        /// often a good choice for European users, however be careful about compatability.
        /// </summary>
        ...
        /// <param name="count"> Number of bytes to convert starting from index 0 </param>
        ...
        /// </summary>
        /// <param name="flags">
        /// The applicable <see cref="GeneralBitFlags"> general purpose bits flags </see>
        /// </param>
        /// <param name="str">   String to convert to an array </param>
        /// <returns> Converted array </returns>
