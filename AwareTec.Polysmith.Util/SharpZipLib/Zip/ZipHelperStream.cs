...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    internal class ZipHelperStream : Stream
    {
        ...
        public int WriteDataDescriptor(ZipEntry entry)
        {
            ...
            {
                // The signature is not PKZIP originally but is now described as optional in the
                // PKZIP Appnote documenting trhe format.
        ...
        public void ReadDataDescriptor(bool zip64, DescriptorData data)
        {
            ...
            // In theory this may not be a descriptor according to PKZIP appnote. In practise its
            // always there.
