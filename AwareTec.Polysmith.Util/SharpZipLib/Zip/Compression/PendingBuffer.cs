...
namespace ICSharpCode.SharpZipLib.Zip.Compression
{
    ...
    public class PendingBuffer
    {
        ...
        public void WriteBits(int b, int count)
        {
			...
			// if (DeflaterConstants.DEBUGGING) { //Console.WriteLine("writeBits("+b+","+count+")"); }
#endif
        ...
        /// <summary>
        /// Flushes the pending buffer into the given output array. If the output array is to small,
        /// only a partial flush is done.
        /// </summary>
