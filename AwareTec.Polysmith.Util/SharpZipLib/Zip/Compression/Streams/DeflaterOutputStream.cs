...
{
    /// <summary>
    /// A special stream deflating or compressing the bytes that are written to it. It uses a
    /// Deflater to perform actual deflating. <br/> Authors of the original java version : Tom
    /// Tromey, Jochen Hoenicke
    /// </summary>
    public class DeflaterOutputStream : Stream
    {
        ...
        /// the output stream where deflated output should be written.
        /// </param>
        /// <param name="deflater">         the underlying deflater. </param>
        ...
        /// <summary>
        /// Gets a value indicating if seeking is supported for this stream This property always
        /// returns false
        /// </summary>
        ...
        /// <summary>
        /// Flushes the stream by calling <see cref="DeflaterOutputStream.Flush"> Flush </see> on the
        /// deflater and then on the underlying stream. This ensures that all bytes are flushed.
        /// </summary>
        ...
        /// <summary>
        /// Calls <see cref="Finish"/> and closes the underlying stream when <see
        /// cref="IsStreamOwner"> </see> is true.
        /// </summary>
        ...
        /// <param name="offset"> The offset into the byte array where to start. </param>
        /// <param name="count">  The number of bytes to write. </param>
        ...
        /// <summary>
        /// This buffer is used temporarily to retrieve the bytes from the deflater and write them to
