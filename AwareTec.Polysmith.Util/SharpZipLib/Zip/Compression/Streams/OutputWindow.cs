...
{
    /// <summary>
    /// Contains the output from the Inflation process. We need to have a window so that we can refer
    /// backwards into the output stream to repeat stuff. <br/> Author of the original java version :
    /// John Leuner
    /// </summary>
