...
// HISTORY 11-08-2009 GeoffHart T9121 Added Multi-member gzip support
...
namespace ICSharpCode.SharpZipLib.Zip.Compression.Streams
{
    ...
    public class InflaterInputBuffer
    {
        ...
        /// <summary>
        /// Call <see cref="Inflater.SetInput(byte[], int, int)"/> passing the current clear text
        /// buffer contents.
        /// </summary>
    ...
    /// <summary>
    /// This filter stream is used to decompress data compressed using the "deflate" format. The
    /// "deflate" format is described in RFC 1951.
    ///
    /// This stream may form the basis for other decompression filters, such as the <see
    /// cref="ICSharpCode.SharpZipLib.GZip.GZipInputStream"> GZipInputStream </see>.
    ///
    ...
    public class InflaterInputStream : Stream
    {
        ...
        /// <summary>
        /// Create an InflaterInputStream with the specified decompressor and a default buffer size
        /// of 4KB.
        /// </summary>
        ...
        /// <summary>
        /// Get/set flag indicating ownership of underlying stream. When the flag is true <see
        /// cref="Close"/> will close the underlying stream also.
        /// </summary>
        ...
        /// <returns> The number of bytes skipped, zero if the end of stream has been reached </returns>
        ...
        /// <summary>
        /// The current position within the stream. Throws a NotSupportedException when attempting to
        /// set the position
        /// </summary>
        ...
        /// <summary>
        /// Writes a sequence of bytes to stream and advances the current position This method always
        ...
        /// </param>
        /// <returns>
        /// An <see cref="System.IAsyncResult"> IAsyncResult </see> that references the asynchronous write
        /// </returns>
        /// <exception cref="NotSupportedException"> Any access </exception>
        ...
        /// <summary>
        /// Closes the input stream. When <see cref="IsStreamOwner"> </see> is true the underlying
        ...
        /// <summary>
        /// Flag indicating wether this instance is designated the stream owner. When closing if this
        /// flag is true the underlying stream is closed.
        /// </summary>
