...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ExtendedUnixData : ITaggedData
    {
        ...
        public void SetData(byte[] data, int index, int count)
        {
            ...
            {
                // bit 0 if set, modification time is present bit 1 if set, access time is present
        ...
        /// <remarks>
        /// The standard Unix time is a signed integer data type, directly encoding the Unix time
        /// number, which is the number of seconds since 1970-01-01. Being 32 bits means the values
        /// here cover a range of about 136 years. The minimum representable time is 1901-12-13
        /// 20:45:52, and the maximum representable time is 2038-01-19 03:14:07.
        /// </remarks>
    ...
    public class NTTaggedData : ITaggedData
    {
        ...
        /// <returns> Returns true if the value is valid and can be represented; false if not. </returns>
        /// <remarks>
        /// NTFS filetimes are 64-bit unsigned integers, stored in Intel (least significant byte
        /// first) byte order. They determine the number of 1.0E-07 seconds (1/10th microseconds!)
        /// past WinNT "epoch", which is "01-Jan-1601 00:00:00 UTC". 28 May 60056 is the upper limit
        /// </remarks>
        public static bool IsValidValue(DateTime value)
        {
            bool result = true;
    ...
    internal interface ITaggedDataFactory
    {
        ...
        /// <param name="count">  The number of bytes to extract. </param>
        /// <returns>
        /// The located <see cref="ITaggedData"> value found </see>, or null if not found.
        /// </returns>
    ...
    /// </summary>
    /// <remarks>
    /// Extra data contains 0 or more values each prefixed by a header tag and length. They contain
    /// zero or more bytes of actual data. The data is held internally using a copy on write
    /// strategy. This is more efficient but means that for extra data created by passing in data can
    /// have the values modified by the caller in some circumstances.
    /// </remarks>
    sealed public class ZipExtraData : IDisposable
    {
        ...
        /// <returns>
        /// Returns a <see cref="Stream"/> containing tag data or null if no tag was found.
        /// </returns>
        ...
        /// <returns>
        /// Returns a <see cref="ITaggedData"> tagged value </see> or null if none found.
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// This is only valid if <see cref="Find"/> has previously returned true. Initially the
        /// result will be the index of the first byte of actual data. The value is updated after
        /// calls to <see cref="ReadInt"/>, <see cref="ReadShort"/> and <see cref="ReadLong"/>.
        /// </remarks>
        ...
        public bool Find(int headerID)
        {
            ...
            // Trailing bytes that cant make up an entry (as there arent enough bytes for a tag and
            // length) are ignored!
        ...
        /// </summary>
        /// <remarks>
        /// Add data using <see cref="AddData(byte[])"/>, <see cref="AddLeShort"/>, <see
        /// cref="AddLeInt"/>, or <see cref="AddLeLong"/>. The new entry is completed and actually
        /// added by calling <see cref="AddNewEntry"/>
        /// </remarks>
        ...
        /// <summary>
        /// Read a short value in little endian form from the last <see cref="Find"> found </see>
        /// data value.
        /// </summary>
