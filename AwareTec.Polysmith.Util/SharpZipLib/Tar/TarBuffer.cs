// TarBuffer.cs Copyright (C) 2001 Mike Krueger
//
...
{
    /// <summary>
    /// The TarBuffer class implements the tar archive concept of a buffered input stream. This
    /// concept goes back to the days of blocked tape drives and special io devices. In the C#
    /// universe, the only real function that this class performs is to ensure that files have the
    /// correct "record" size, or other tars will complain.
    /// <p>
    ...
    public class TarBuffer
    {
        ...
        */
        ...
        /// </summary>
        /// <value>
        /// The record size in bytes. This is equal to the <see cref="BlockFactor"/> multiplied by
        /// the <see cref="BlockSize"/>
        /// </value>
        ...
        /// <summary>
        /// Determine if an archive block indicates End of Archive. End of archive is indicated by a
        /// block that consists entirely of null bytes. All remaining blocks for the record should
        /// also be null's However some older tars only do a couple of null blocks (Old GNU tar for
        /// one) and also partial records
        /// </summary>
        ...
        /// <summary>
        /// Determine if an archive block indicates the End of an Archive has been reached. End of
        /// archive is indicated by a block that consists entirely of null bytes. All remaining
        /// blocks for the record should also be null's However some older tars only do a couple of
        /// null blocks (Old GNU tar for one) and also partial records
        /// </summary>
        /// <param name="block"> The data block to check. </param>
        /// <returns> Returns true if the block is an EOF block; false otherwise. </returns>
        ...
        private bool ReadRecord()
        {
            ...
            while (bytesNeeded > 0)
            {
                ...
                // NOTE We have found EOF, and the record is not full!
                //
                // This is a broken archive. It does not follow the standard blocking algorithm.
                // However, because we are generous, and it requires little effort, we will simply
                // ignore the error and continue as if the entire record were read. This does not
                // appear to break anything upstream. We used to return false in this case.
                //
        ...
        /// <see cref="BlockFactor"> block factor </see>) + <see cref="GetCurrentBlockNum"> block
        /// number </see>.
        /// </remarks>
        ...
        /// </summary>
        /// <param name="buffer"> The buffer containing the record data to write. </param>
        ...
        /// </summary>
        /// <remarks>
        /// Any trailing bytes are set to zero which is by definition correct behaviour for the end
        /// of a tar stream.
        /// </remarks>
