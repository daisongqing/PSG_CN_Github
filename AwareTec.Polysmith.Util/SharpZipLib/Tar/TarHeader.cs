...
{
    /// <summary>
    /// This class encapsulates the Tar Entry Header used in Tar Archives. The class also holds a
    /// number of tar constants, used mostly in headers.
    /// </summary>
    public class TarHeader : ICloneable
    {
        ...
        /// <summary>
        /// GNU dir dump file type This is a dir entry that contains the names of files that were in
        ...
        /// <param name="length">
        /// The number of header bytes to update. It's formatted differently from the other fields:
        /// it has 6 digits, a null, then a space -- rather than digits, a space, then a null. The
        /// final space is already there, from checksumming
        /// </param>
        ...
        /// <summary>
        /// Compute the checksum for a tar entry header. The checksum field must be all spaces prior
        /// to this happening
        /// </summary>
        ...
        private static int GetCTime(System.DateTime dateTime)
        {
