...
// HISTORY 28-01-2010 DavidPierson Added IsStreamOwner
...
namespace ICSharpCode.SharpZipLib.Tar
{
    ...
    /// <summary>
    /// The TarArchive class implements the concept of a 'Tape Archive'. A tar archive is a series of
    /// entries, each of which represents a file system object. Each entry in the archive consists of
    /// a header block followed by 0 or more data blocks. Directory entries consist only of the
    /// header block, and are followed by entries for the directory's contents. File entries consist
    /// of a header followed by the number of blocks needed to contain the file's contents. All
    /// entries are written on block boundaries. Blocks are 512 bytes long.
    ///
    /// TarArchives are instantiated in either read or write mode, based upon whether they are
    /// instantiated with an InputStream or an OutputStream. Once instantiated TarArchives read/write
    /// mode can not be changed.
    ///
    /// There is currently no support for random access to tar archives. However, it seems that
    /// subclassing TarArchive, and using the TarBuffer.CurrentRecord and TarBuffer.CurrentBlock
    /// properties, this would be rather trivial.
    /// </summary>
    public class TarArchive : IDisposable
    {
        /// <summary>
        /// Ensures that resources are freed and other cleanup operations are performed when the
        ...
        /// <summary>
        /// Get or set a value indicating if overrides defined by <see cref="SetUserInfo">
        /// SetUserInfo </see> should be applied.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Get/set the ascii file translation flag. If ascii file translation is true, then the file
        /// is checked to see if it a binary file or not. If the flag is true and the test indicates
        /// it is ascii text file, it will be translated. The translation converts the local
        /// operating system's concept of line ends into the UNIX line end, '\n', which is the
        /// defacto standard for a TAR archive. This makes text files compatible with UNIX.
        /// </summary>
        ...
        /// <summary>
        /// Get the archive group id. See <see cref="ApplyUserInfoOverrides"> ApplyUserInfoOverrides
        /// </see> for detail on how to allow setting values on a per entry basis.
        /// </summary>
        ...
        /// <summary>
        /// Get the archive group name. See <see cref="ApplyUserInfoOverrides">
        /// ApplyUserInfoOverrides </see> for detail on how to allow setting values on a per entry basis.
        /// </summary>
        ...
        /// <summary>
        /// Sets the IsStreamOwner property on the underlying stream. Set this to false to prevent
        /// the Close of the TarArchive from closing the stream.
        /// </summary>
        ...
        /// <summary>
        /// PathPrefix is added to entry names as they are written if the value is not null. A slash
        /// character is appended after PathPrefix
        /// </summary>
        ...
        /// <summary>
        /// Get the archive's record size. Tar archives are composed of a series of RECORDS each
        /// containing a number of BLOCKS. This allowed tar archives to match the IO characteristics
        /// of the physical device being used. Archives are expected to be properly "blocked".
        /// </summary>
        ...
        /// <summary>
        /// Get the archive user id. See <see cref="ApplyUserInfoOverrides"> ApplyUserInfoOverrides
        /// </see> for detail on how to allow setting values on a per entry basis.
        /// </summary>
        ...
        /// <summary>
        /// Get the archive user name. See <see cref="ApplyUserInfoOverrides"> ApplyUserInfoOverrides
        /// </see> for detail on how to allow setting values on a per entry basis.
        /// </summary>
        ...
        ///
        /// NOTE That this method uses the <see cref="ProgressMessageEvent"> progress event </see> to
        /// actually list the contents. If the progress display event is not set, nothing will be listed!
        /// </summary>
        ...
        /// </summary>
        /// <param name="translateAsciiFiles"> If true, translate ascii text files. </param>
        ...
        /// <summary>
        /// Set user and group information that will be used to fill in the tar archive's entry
        /// headers. This information is based on that available for the linux operating system,
        /// which is not always available on other operating systems. TarArchive allows the
        /// programmer to specify values to be used in their place. <see
        /// cref="ApplyUserInfoOverrides"/> is set to true by this call.
        /// </summary>
        ...
        /// <summary>
        /// Write an entry to the archive. This method will call the putNextEntry and then write the
        /// contents of the entry, and finally call closeEntry() for entries that are files. For
        /// directories, it will call putNextEntry(), and then, if the recurse flag is true, process
        /// each entry that is a child of the directory.
        /// </summary>
        ...
        /// <summary>
        /// Releases the unmanaged resources used by the FileStream and optionally releases the
        /// managed resources.
        /// </summary>
        ...
        /// <summary>
        /// The InputStream based constructors create a TarArchive for the purposes of extracting or
        /// listing a tar archive. Thus, use these constructors when you wish to extract files from
        /// or list the contents of an existing tar archive.
        /// </summary>
        ...
        // TODO: TarArchive - Is there a better way to test for a text file? It no longer reads
        // entire files into memory but is still a weak test! This assumes that byte values 0-7,
        // 14-31 or 255 are binary and that all non text files contain one of these values
        ...
        /// <summary>
        /// Extract an entry from the archive. This method assumes that the tarIn stream has been
        /// properly set with a call to GetNextEntry().
        /// </summary>
        /// <param name="destDir"> The destination directory into which to extract. </param>
