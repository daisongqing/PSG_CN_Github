...
{
    /// <summary>
    /// The TarInputStream reads a UNIX tar archive as an InputStream. methods are provided to
    ...
    public class TarInputStream : Stream
    {
        ...
        /// <summary>
        /// Get the available data that can be read from the current entry in the archive. This does
        /// not indicate how much data is left in the entire archive, only in the current entry. This
        /// value is determined from the entry's size header field and the amount of data already
        ...
        /// <summary>
        /// Gets a value indicating whether the current stream supports seeking This property always
        /// returns false.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the position within the stream. Setting the Position is not supported and
        /// throws a NotSupportedExceptionNotSupportedException
        /// </summary>
        ...
        /// <summary>
        /// Closes this stream. Calls the TarBuffer's close() method. The underlying stream is closed
        /// by the TarBuffer.
        /// </summary>
        ...
        ///
        /// This method is aware of the boundaries of the current entry in the archive and will deal
        ...
        /// <summary>
        /// Writes a block of bytes to this stream using data from a buffer. This operation is not
        ...
        /// <summary>
        /// Writes a byte to the current position in the file stream. This operation is not supported
        /// and will throw a NotSupportedException
        /// </summary>
        ...
        /// <summary>
        /// Get the next entry in this tar archive. This will skip over any remaining data in the
        /// current entry, if there is one, and place the input stream at the header of the next
        /// entry, and read the header and instantiate a new TarEntry from the header bytes and
        /// return that entry. If there are no more entries in the archive, null will be returned to
        ...
        /// <summary>
        /// Skip bytes in the input buffer. This skips bytes in the current entry's data, not the
        /// entire archive, and will stop at the end of the current entry's data if the number to
        /// skip extends beyond that point.
        /// </summary>
        /// <param name="skipCount"> The number of bytes to skip. </param>
        public void Skip(long skipCount)
        {
            // TODO: REVIEW efficiency of TarInputStream.Skip This is horribly inefficient, but it
            // ensures that we properly skip over bytes via the TarBuffer...
