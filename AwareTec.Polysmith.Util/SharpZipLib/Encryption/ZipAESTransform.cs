...
namespace ICSharpCode.SharpZipLib.Encryption
{
    ...
    internal class ZipAESTransform : ICryptoTransform
    {
        ...
        // For 128-bit AES (16 bytes) the encryption is implemented as expected. For 256-bit AES (32
        // bytes) WinZip do full 256 bit AES of the nonce to create the encryption block but use only
        // the first 16 bytes of it, and discard the second half.
        ...
        /// Random bytes, length depends on encryption strength. 128 bits = 8 bytes, 192 bits = 12
        /// bytes, 256 bits = 16 bytes.
        /// </param>
        ...
        {
            // Pass the data stream to the hash algorithm for generating the Auth Code. This does not
            // change the inputBuffer. Do this before decryption for read mode.
            if (!_writeMode)
            {
        ...
        /// <summary>
        /// Returns the 10 byte AUTH CODE to be checked or appended immediately following the AES
        /// data stream.
        /// </summary>
