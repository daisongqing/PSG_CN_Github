...
namespace ICSharpCode.SharpZipLib.Encryption
{
    ...
    internal class ZipAESStream : CryptoStream
    {
            ...
            : base(stream, transform, mode)
        {
            ...
            // mode: CryptoStreamMode.Read means we read from "stream" and pass decrypted to our
            // Read() method. Write bypasses this stream and uses the Transform directly.
        ...
        /// <summary>
        /// Reads a sequence of bytes from the current CryptoStream into buffer, and advances the
        ...
        public override int Read(byte[] outBuffer, int offset, int count)
        {
            ...
            while (nBytes < count)
            {
                ...
                // Need to handle final block and Auth Code specially, but don't know total data
                // length. Maintain a read-ahead equal to the length of (crypto block + Auth Code).
