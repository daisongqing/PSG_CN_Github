...
namespace ICSharpCode.SharpZipLib.BZip2
{
    ...
    {
        /// <summary>
        /// Decompress the <paramref name="inStream"> input </paramref> writing uncompressed data to
        /// the <paramref name="outStream"> output stream </paramref>
        /// </summary>
        ...
        /// <summary>
        /// Compress the <paramref name="inStream"> input stream </paramref> sending result data to
        /// <paramref name="outStream"> output stream </paramref>
        /// </summary>
        /// <param name="inStream">      The readable stream to compress. </param>
        /// <param name="outStream">     The output stream to receive the compressed data. </param>
        /// <param name="isStreamOwner"> Both streams are closed on completion if true. </param>
        /// <param name="level">
        /// Block size acts as compression level (1 to 9) with 1 giving the lowest compression and 9
        /// the highest.
        /// </param>
