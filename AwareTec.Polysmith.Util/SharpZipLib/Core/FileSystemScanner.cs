...
namespace ICSharpCode.SharpZipLib.Core
{
    ...
    public class FileSystemScanner
    {
        ...
        /// </summary>
        /// <param name="filter">
        /// The <see cref="PathFilter"> file filter </see> to apply when scanning.
        /// </param>
        ...
        /// </summary>
        /// <param name="fileFilter">
        /// The file <see cref="IScanFilter"> filter </see> to apply.
        /// </param>
        /// <param name="directoryFilter">
        /// The directory <see cref="IScanFilter"> filter </see> to apply.
        /// </param>
